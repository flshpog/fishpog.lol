...
export const NAV_ITEMS: NavItem[] = [
  ...
  { id: "turnips", label: "Turnip Calculator", href: "/turnips", icon: "/icons/modules/turnips.svg", group: "tools" },
  ...
  { id: "island-designer", label: "Island Designer", href: "/island-designer", icon: "/icons/modules/island-designer.svg", group: "tools" },
